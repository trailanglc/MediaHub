...
func NewLoginRateLimiter(rdb *redis.Client, maxFails int, window time.Duration, failClosed bool) *LoginRateLimiter {
	return &LoginRateLimiter{rdb: rdb, maxFails: maxFails, window: window, failClosed: failClosed}
}
