...
Tài liệu bản đồ monorepo — bổ sung cho [mediahub_production_spec.md](../mediahub_production_spec.md) (đặc tả sản phẩm) và [Cài đặt](../getting-started/02-installation.md).
