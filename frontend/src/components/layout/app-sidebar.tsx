...
export function AppSidebar({ className }: { className?: string }) {
  ...
  return (
    <aside
      className={cn(
        "flex w-56 shrink-0 flex-col border-r border-sidebar-border bg-sidebar p-3 text-sidebar-foreground",
        className,
      )}
    >
      <Link
        href="/dashboard"
        className="mb-5 block px-2 text-lg font-bold tracking-tight text-sidebar-foreground"
      >
        MediaHub
      </Link>
